...
public class TableParser {
	...
	private static void parseColumn(Table table, Class<?> entityClass) {
		...
		List<org.walkerljl.toolkit.db.orm.entity.Column> columns = table.getColumns();
		if (columns == null) {
			columns = new ArrayList<org.walkerljl.toolkit.db.orm.entity.Column>();
		...
		for (Field field : fields) {
			...
			org.walkerljl.toolkit.db.orm.entity.Column column = new org.walkerljl.toolkit.db.orm.entity.Column();
			columns.add(column);
